...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        expect(rules_page.get_by_role("heading", name="PiScrow User Agreement")).to_be_visible()
        expect(rules_page.get_by_role("heading", name="Proof Upload Consent")).to_be_visible()
        expect(rules_page.get_by_role("heading", name="Admin Review And Disputes")).to_be_visible()
        rules_page.close()
        ...
        page.wait_for_load_state("networkidle")
        expect(page.get_by_role("button", name="Ledger", exact=True)).to_be_visible()
        expect(page.get_by_role("button", name="Buyer", exact=True)).to_be_visible()
        expect(page.get_by_role("button", name="Seller", exact=True)).to_be_visible()
        ...
        page.get_by_role("button", name="Seller", exact=True).click()
        ...
        page.get_by_role("button", name="Buyer", exact=True).click()
        ...
        expect(page.get_by_text("Buyer receipt proof", exact=True)).to_be_visible()
        close_sheet(page)
        ...
        expect(page.get_by_text("Admin Review Queue")).to_be_visible()
        expect(page.get_by_text("Verified Badge Requests")).to_be_visible()
        expect(page.get_by_text("No badge requests waiting.")).to_be_visible()
        expect(page.get_by_role("button", name="Enter Review Room")).to_be_visible()
        ...
        expect(admin_sheet.get_by_role("heading", name="Trade Chat")).to_be_visible()
        expect(admin_sheet.get_by_role("button", name="Open full conversation")).to_be_visible()
        ...
        expect(mobile.get_by_role("button", name="Ledger", exact=True)).to_be_visible()
